<template>
  <div>
    <div class="box">
      <div class="field is-grouped">
        <p class="control is-expanded has-icons-left">
          <input class="input" type="text" placeholder="Search" v-model="queryData" />
          <span class="icon is-small is-left">
            <i class="fas fa-search" />
          </span>
        </p>
        <p class="control">
          <a class="button is-primary" @click="queryInput = queryData">Search</a>
        </p>
      </div>
    </div>
    <div class="box table-container">
      <div class="level table-header-sticky">
        <div class="level-left">
          <div class="buttons">
            ...
            <button class="button is-secondary is-left" @click="generateReport">
      ...
      <data-table :table-data="pagingList" :columns="table_columns" :query="queryInput">
        <template slot="rowFunctions" slot-scope="props">
          <span data-tooltip="Edit">
            <a class="button is-white" @click="editRow(props.targetItem)">
              <i class="fas fa-edit" />
            </a>
          </span>
        </template>
        <template slot="rowBoolean" slot-scope="props">
      ...
      <div class="table-footer-sticky" v-show="totalCount>0">
        <pagination
