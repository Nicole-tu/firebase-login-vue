<template>
  <div>
    ...
    <template v-if="categoryList.length==0">
      ...
      <div class="field has-addons">
        <div class="control is-expanded">
          <input class="input" type="text" placeholder="Category Name" v-model="newCategoryName" />
        </div>
        <div class="control">
          <button class="button is-success" data-tooltip="Save" @click="newCategory">
    ...
    <template v-else>
      <div class="table-container" ref="collapsibles" id="table-accordion">
        ...
        <table class="table is-fullwidth" :class="{'is-hoverable':!isEdit}">
          <thead>
            <tr>
            ...
            <template v-for="(item,i) in categoryList">
              <tr :key="i">
                <td class="chevron-cell">
                  ...
                  >
                    <i :id="`chevron${i}`" class="fas fa-chevron-right" />
                  </a>
                </td>
                <td>
                  <div class="field has-addons is-small" v-if="isEdit">
                    <div class="control">
                      <input
              ...
              <tr :key="`sub-${i}`" :id="`tr-table-${i}`" style="display:none">
                <td></td>
                <td colspan="2">
    ...
    <box-modal :id="'modal-add-subcategory'" :is-show-modal="isShowNewSubcateModal">
      <template #content>
        ...
        <div class="field is-grouped is-grouped-right">
          <p class="control">
            <a class="button is-light" @click="isShowNewSubcateModal=false">Cancel</a>
          </p>
          <p class="control">
            <a class="button is-primary" @click="addSubcategory">Add</a>
          </p>
        </div>
      </template>
    </box-modal>
