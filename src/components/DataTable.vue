<template>
  <div>
    <table class="table is-fullwidth">
      <thead>
        <tr>
          <th v-for="(column, index) in view_columns" :key="index">
            <span>{{ column }}</span>

            <div class="column-controls" v-if="hasSortColumn">
      ...
      <tbody>
        <tr v-for="(row,r) in view_data" :key="r">
          <td v-for="(column,c) in row" :key="c">{{ column }}</td>
        </tr>
